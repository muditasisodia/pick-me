...
<html>
    ...
    <body>
        <div class = "wrapper">
            ...
            <div class ="content">
                        <center>
        <form action="voldone.jsp">
            <br><br>
            <b>Name: </b><input type="text" name="name" value="" />
            <br><br>
            <b>Number: </b> <input type="text" name="number" value="" />
            <br><br>
            <b>Choose a date: </b><select name="date" size="4">
                <option>26.10.2017</option>
                <option>27.10.2017</option>
                <option>28.10.2017</option>
                <option>29.10.2017</option>
            </select>
            <br><br>
            <input type="submit" class="button" value="Volunteer!" />
        </form>
        <a href="index.html"><input type="submit" class="button" value="Exit" /></a>
    </center>
            </div>
            <div class="sidebar">
                <B>The Story of Crookshanks</B>
                <br><br>
                <img src="images/Crookshanks.jpg" width="300" height="300" alt="crook"/>
                <br><br>
