    ...
    <body>
        ...
        String url = "jdbc:sqlserver://localhost:1433;databaseName=seproj;integratedSecurity=true";
           ...
           int flag = 0;
               ...
               {
                   %><br><br><center><h1>Invalid Number</h1></center><%
                   flag = 1;
               }           
           if(flag==0) {
           int count = 0;
...
%><center><br><br><h1>Please enter a 10 digit number</h1>
    <a href="vol.jsp">  <input type="submit" class="button" value="Back" />  </a></center>
                 <%
            }
            }
            else { %>
                   <center>
            <a href="vol.jsp">  <input type="submit" class="button" value="Back" />  </a>
                   </center>
            <% } %>
            </div>
            <div class="sidebar">
